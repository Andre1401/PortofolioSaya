    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($penjualan) {
                return '
                <div>
                    <button onclick="showDetail(`'. route('penjualan.show', $penjualan->id) .'`)" class="btn btn-info btn-flat"><i class="fa fa-eye"></i></button> 
                    <button onclick="deleteData(`'. route('penjualan.destroy', $penjualan->id) .'`)" class="btn btn-danger btn-flat"><i class="fa fa-trash"></i></button> 
                </div>
                ';
            })
