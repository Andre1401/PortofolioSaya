            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="nama_perusahaan" class="col-lg-2 offset-lg-1 control-label">Nama Perusahaan</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="telepon" class="col-lg-2 offset-lg-1 control-label">Telepon</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="alamat" class="col-lg-2 offset-lg-1 control-label">Alamat</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="path_logo" class="col-lg-2 offset-lg-1 control-label">Logo Perusahaan</label>
                        <div class="col-lg-4">
                    ...
                    <!-- <div class="form-group row">
                        <label for="path_kartu_member" class="col-lg-2 offset-lg-1 control-label">Kartu Member</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <label for="diskon" class="col-lg-2 offset-lg-1 control-label">Diskon</label>
                        <div class="col-lg-2">
                    ...
                    <div class="form-group row">
                        <label for="tipe_nota" class="col-lg-2 offset-lg-1 control-label">Tipe Nota</label>
                        <div class="col-lg-2">
                ...
                <div class="card-footer text-right">
                    <button class="btn btn-flat btn-primary">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
    ...
    function showData() {
        $.get('{{ route('setting.show') }}')
            .done(response => {
                ...
                $('.brand-image').attr('src', `${response.path_logo}`)
